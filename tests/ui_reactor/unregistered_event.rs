...
// A typo. §22.14 rule 2: refused when the binding is written, not discovered
// later as an event that never fires.
#[reactor_handler("token.pre_isue")]
async fn enrich(_event: ReactorEvent) -> ReactorDecision {
