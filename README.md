...
`tests/fixtures/v2_reference_vectors.json` is generated by the AXIAM server's AMQP sign path
and vendored here verbatim. It pins this SDK's HMAC implementation byte-for-byte to the server's
