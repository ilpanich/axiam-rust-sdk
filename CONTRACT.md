...
**Canonical reference vectors.** `testdata/v2_reference_vectors.json`
...
It is generated by the AXIAM server (`crates/axiam-amqp`) and vendored verbatim
into each SDK repository; re-vendor it whenever this section changes.
